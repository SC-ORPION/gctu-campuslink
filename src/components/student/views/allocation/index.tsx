    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="premium-card p-8 space-y-4">
          <div className="skeleton-line w-24 h-4 bg-slate-100"></div>
          <div className="skeleton-line w-48 h-6 bg-slate-100"></div>
        </div>
        <div className="premium-card p-8 space-y-3">
          <div className="skeleton-line w-full h-8 bg-slate-100"></div>
          <div className="skeleton-line w-full h-8 bg-slate-100"></div>
          <div className="skeleton-line w-2/3 h-6 bg-slate-100"></div>
        </div>
      </div>
    );
  }
