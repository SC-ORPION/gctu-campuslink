...
export interface IntegrityIssue {
  type: 'ORPHAN_BOOKING' | 'MISSING_ALLOCATION' | 'PAYMENT_MISMATCH' | 'ROOM_OVERCAPACITY' | 'INVALID_TRANSITION';
...
export class IntegrityChecker {
   ...
   */
  static async runIntegrityCheck(): Promise<{ success: boolean; issues: IntegrityIssue[] }> {
    ...
    const studentsTrack: Record<string, string> = {};
