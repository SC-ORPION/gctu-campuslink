...
// ============================================================================
const globalSecurityEvents = globalThis;
...
class SecurityEventLogger {
    ...
    static async log(event) {
        ...
        console.log(`[SECURITY_EVENT] ${severityIcon} [${fullEvent.severity}] ${fullEvent.type} | ` +
    ...
    static async logPermissionDenied(actorId, attemptedAction, reason, metadata) {
        return this.log({
    ...
    static async logLockdownActivated(actorId, reason) {
        return this.log({
    ...
    static async logLockdownDeactivated(actorId) {
        return this.log({
    ...
    static async logSuspiciousActivity(actorId, activityType, description, metadata) {
        return this.log({
    ...
    static async logRateLimitTriggered(actorId, actionType, details) {
        return this.log({
    ...
    static async logRateLimitEscalated(actorId, actionType, violationCount, cooldownMs) {
        return this.log({
    ...
    static async logOverrideBlocked(actorId, action, reason) {
        return this.log({
    ...
    static async logSessionAnomaly(actorId, description, metadata) {
        return this.log({
    ...
    static async logEmergencyRecovery(actorId, phase, details) {
        return this.log({
    ...
    static async logIntegrityViolation(description, targetEntity, metadata) {
        return this.log({
    ...
    static getRecentEvents(minutes = 60) {
